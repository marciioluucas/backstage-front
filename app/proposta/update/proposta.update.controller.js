var propostaUpdateController = angular.module('proposta.update.controller', []);

propostaUpdateController.controller('propostaUpdateCtrl', ['$scope'
    ...
    function ($scope, propostaFactory, $backstageToast, $backstageDialog, $state) {
        ...
        $scope.enviar = function () {
            ...
            // console.log(params);
            propostaFactory.update(params).prototype.$update().then(
                function (value) {
